...
@Component({
  selector: 'app-bcmadmin-list',
  templateUrl: './bcmadmin-list.component.html',
  styleUrls: ['./bcmadmin-list.component.scss']
})
 

export class BCMAdminListComponent implements AfterViewInit {
